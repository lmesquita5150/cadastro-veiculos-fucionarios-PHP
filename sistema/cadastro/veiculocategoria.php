                          ...
                          <div class="row align-items-end">
                            ...
                            <div class="col-12 col-lg-6 col-xl-6  mb-3  ">
                              <label class="float-label">Descrição</label>
                               <input type="text" placeholder="Descrição"  class="form-control clear" name="descricao"  id="editdescricao"  />
                            </div>  
...
<script type="text/javascript" src="veiculocategoria.js"></script>
